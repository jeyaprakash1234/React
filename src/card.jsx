...
//       <li><span class="fa-li"><i class="fas fa-check"></i></span>{props.details.Community} </li>
//       <li class="text-muted"><span class="fa-li"><i class="fas fa-times"></i></span>{props.details.Private}</li>
